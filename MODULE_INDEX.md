...
| Bootstrap a front | `mystorax-hosts-manifest` | `mystorax_hosts_manifest` | `GET /v1/hosts/manifest` | List live tools and Hands |
...
| Apply an artifact | `mystorax-hands-thin` | `mystorax_hosts_manifest` | `GET /v1/hosts/manifest` | Use the first healthy thin Hand |
...
| Configure transport/auth | `mystorax-connectors-credentials` | `mystorax_hosts_manifest` | `GET /v1/hosts/manifest` | Reference the local token file; never copy its value |
...
| Onboard a peer front | `mystorax-front-onboard` | `mystorax_hosts_manifest` | `GET /v1/hosts/manifest` | Follow the matching connector card |
