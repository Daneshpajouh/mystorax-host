...
# Components include peer-front plugins, doctrine modules, MCP, OpenAPI, rules, and commands.
set -euo pipefail
...
if $install_claude; then
  copy_doctrine_modules "$HOME/.claude/skills"
  ...
  echo "claude_doctrine_modules=$HOME/.claude/skills"
  echo "claude_plugin=$claude_plugin"
fi

if $install_codex; then
  copy_doctrine_modules "$HOME/.codex/skills"
  echo "codex_doctrine_modules=$HOME/.codex/skills"
fi
